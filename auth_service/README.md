...
```bash
curl -i http://52.66.197.225:6060/hello
curl -i http://52.66.197.225:6060/health
curl -i http://52.66.197.225:6060/docs
curl -i http://52.66.197.225:6060/openapi.json
```
...
```bash
curl -X POST 'http://52.66.197.225:6060/v1/signup' \
...
```bash
curl -X POST 'http://52.66.197.225:6060/v1/admin/register' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
...
```bash
curl -X POST 'http://52.66.197.225:6060/v1/signin' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
...
curl -i 'http://52.66.197.225:6060/v1/me' \
...
```bash
curl -X POST 'http://52.66.197.225:6060/v1/password/forgot' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
...
```bash
curl -X POST 'http://52.66.197.225:6060/v1/password/reset' \
  -H 'accept: application/json' \
  -H 'Content-Type: application/json' \
  -d '{
...
```bash
curl -i 'http://52.66.197.225:6060/v1/admin/requests' \
...
```bash
curl -X POST 'http://52.66.197.225:6060/v1/admin/requests/<user_id>/decision' \
  -H "Authorization: Bearer ${ADMIN_ACCESS_TOKEN}" \
  -H 'Content-Type: application/json' \
  -d '{
    "decision": "approve",

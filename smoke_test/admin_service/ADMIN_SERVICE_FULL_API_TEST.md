...
CALC_BASE_URL=http://52.66.197.225:2020
...
|---|---|---:|
| `ADMIN_BASE_URL` | Admin service URL | `http://52.66.197.225:1010` |
| `AUTH_BASE_URL` | Auth service URL | `http://52.66.197.225:6060` |
...
Admin Base URL:       http://52.66.197.225:1010
Auth Base URL:        http://52.66.197.225:6060
Mutation mode:        0

...
CALC_BASE_URL=http://3.108.225.164:2020
...
|---|---|---:|
| `ADMIN_BASE_URL` | Admin service URL | `http://3.108.225.164:1010` |
| `AUTH_BASE_URL` | Auth service URL | `http://3.108.225.164:6060` |
...
Admin Base URL:       http://3.108.225.164:1010
Auth Base URL:        http://3.108.225.164:6060
Mutation mode:        0

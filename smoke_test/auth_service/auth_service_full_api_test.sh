...
AUTH_BASE_URL="${AUTH_BASE_URL:-http://52.66.223.53:6060}"
ADMIN_BASE_URL="${ADMIN_BASE_URL:-http://52.66.223.53:1010}"
USER_BASE_URL="${USER_BASE_URL:-http://52.66.223.53:4040}"
CALCULATOR_BASE_URL="${CALCULATOR_BASE_URL:-http://52.66.223.53:2020}"
TODO_BASE_URL="${TODO_BASE_URL:-http://52.66.223.53:3030}"
REPORT_BASE_URL="${REPORT_BASE_URL:-http://52.66.223.53:5050}"

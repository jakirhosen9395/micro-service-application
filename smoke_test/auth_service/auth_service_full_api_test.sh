...
AUTH_BASE_URL="${AUTH_BASE_URL:-http://192.168.56.100:6060}"
ADMIN_BASE_URL="${ADMIN_BASE_URL:-http://192.168.56.100:1010}"
USER_BASE_URL="${USER_BASE_URL:-http://192.168.56.100:4040}"
CALCULATOR_BASE_URL="${CALCULATOR_BASE_URL:-http://192.168.56.100:2020}"
TODO_BASE_URL="${TODO_BASE_URL:-http://192.168.56.100:3030}"
REPORT_BASE_URL="${REPORT_BASE_URL:-http://192.168.56.100:5050}"

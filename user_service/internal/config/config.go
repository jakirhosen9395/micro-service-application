...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		PostgresHost:          getenv("USER_POSTGRES_HOST", "172.31.19.122"),
		...
		RedisHost:            getenv("USER_REDIS_HOST", "172.31.19.122"),
		...
		KafkaBootstrapServers: splitCSV(getenv("USER_KAFKA_BOOTSTRAP_SERVERS", "172.31.19.122:9092")),
		...
		S3Endpoint:       getenv("USER_S3_ENDPOINT", "http://172.31.19.122:9000"),
		...
		MongoHost:          getenv("USER_MONGO_HOST", "172.31.19.122"),
		...
		APMServerURL:             getenv("USER_APM_SERVER_URL", "http://172.31.19.122:8200"),
		...
		ElasticsearchURL:         getenv("USER_ELASTICSEARCH_URL", "http://172.31.19.122:9200"),
		...
		KibanaURL:                getenv("USER_KIBANA_URL", "http://172.31.19.122:5601"),
		...
		LogstashHost:    getenv("USER_LOGSTASH_HOST", "172.31.19.122"),

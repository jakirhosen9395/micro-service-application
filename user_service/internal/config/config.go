...
func Load() (Config, error) {
	...
	cfg := Config{
		...
		PostgresHost:          getenv("USER_POSTGRES_HOST", "192.168.56.200"),
		...
		RedisHost:            getenv("USER_REDIS_HOST", "192.168.56.200"),
		...
		KafkaBootstrapServers: splitCSV(getenv("USER_KAFKA_BOOTSTRAP_SERVERS", "192.168.56.200:9092")),
		...
		S3Endpoint:       getenv("USER_S3_ENDPOINT", "http://192.168.56.200:9000"),
		...
		MongoHost:          getenv("USER_MONGO_HOST", "192.168.56.200"),
		...
		APMServerURL:             getenv("USER_APM_SERVER_URL", "http://192.168.56.200:8200"),
		...
		ElasticsearchURL:         getenv("USER_ELASTICSEARCH_URL", "http://192.168.56.200:9200"),
		...
		KibanaURL:                getenv("USER_KIBANA_URL", "http://192.168.56.200:5601"),
		...
		LogstashHost:    getenv("USER_LOGSTASH_HOST", "192.168.56.200"),
